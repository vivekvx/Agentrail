...
import { CodebaseDocs } from "@/components/codebase-docs";
...
export default function RepoPage({
  ...
  const [view, setView] = useState<"map" | "tour" | "chat" | "docs" | "tree">("map");
                  ...
                  <div className="mt-10">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex gap-1 rounded-lg border border-[var(--hairline)] bg-[var(--surface-card)] p-1">
                        {(["map", "tour", "chat", "docs", "tree"] as const).map((v) => (
                          <button
                            key={v}
                            onClick={() => setView(v)}
                    ...
                    <div className="mt-4">
                      ...
                      {view === "docs" && <CodebaseDocs repo={repo} />}
                      {view === "tree" && (
